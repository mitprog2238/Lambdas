package org.mitprog1.aws.awp.handler;
...
public class ImageProcessHandler implements RequestHandler<Map<String, Object>, APIGatewayProxyResponseEvent> {
    ...
    private static final String SNS_QUEUE_NAME = "task9-uploads-notification-queue-1";
    private static final String TOPIC_ARN = "arn:aws:sns:eu-central-1:701601555014:task9-uploads-notification-topic-1";
